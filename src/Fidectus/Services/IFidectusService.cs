...
namespace Fidectus.Services
{
    public interface IFidectusService
    {
        ...
        Task<GetConfirmationResponse> GetBoxResult(string companyId, string docId, RequestTokenResponse requestTokenResponse, IFidectusConfiguration fidectusConfiguration);
    }
}